import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version as version$1, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, computed, Fragment, createVNode, Text, onServerPrefetch, mergeProps, useSSRContext, resolveComponent, useAttrs, openBlock, createElementBlock, renderSlot, createCommentVNode, createElementVNode, useId, withCtx, Transition, createBlock, withModifiers, provide, createTextVNode, toDisplayString as toDisplayString$1, Suspense, nextTick, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "hookable";
import { getContext } from "unctx";
import { sanitizeStatusCode, createError as createError$1, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie, appendHeader } from "h3";
...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  {
    name: "categories",
    path: "/categories",
    component: () => import("./_nuxt/categories-nNVPT40Q.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import("./_nuxt/checkout-B_IEamxG.js")
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-D1qamV10.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-NxxdEL6l.js")
  },
  {
    name: "my-account",
    path: "/my-account",
    component: () => import("./_nuxt/index-DR6-lD7e.js")
  },
  {
    name: "my-account-lost-password",
    path: "/my-account/lost-password",
    component: () => import("./_nuxt/lost-password-DF6ffqs8.js")
  },
  {
    name: "order-summary",
    path: "/order-summary",
    component: () => import("./_nuxt/order-summary-BOPGk4h7.js")
  },
  {
    name: "product-category-slug",
    path: "/product-category/:slug()",
    component: () => import("./_nuxt/_slug_-odhYM9Qz.js")
  },
  {
    name: "product-slug",
    path: "/product/:slug()",
    component: () => import("./_nuxt/_slug_-CwK0iu0q.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-D4E822Hu.js")
  },
  {
    name: "wishlist",
    path: "/wishlist",
    component: () => import("./_nuxt/wishlist-TlRLCIW5.js")
  },
  {
...
const __nuxt_component_1_lazy$1 = defineAsyncComponent(() => import("./_nuxt/Cart-C-ZKzS6H.js").then((c) => c.default || c));
...
const __nuxt_component_1_lazy = defineAsyncComponent(() => import("./_nuxt/Cart-C-ZKzS6H.js").then((c) => c.default || c));
...
export {
  ...
  useRouter as k,
  GqlCheckout as l,
  useRuntimeConfig as m,
  useAppConfig as n,
  useI18n as o,
  useRoute as p,
  useSeoMeta as q,
  GqlGetAllowedCountries as r,
  GqlGetStates as s,
  useLazyAsyncData as t,
  useCart as u,
  useImage as v,
  useProducts as w,
  useSorting as x,
