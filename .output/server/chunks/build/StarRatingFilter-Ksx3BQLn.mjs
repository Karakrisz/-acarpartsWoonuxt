import { y as useFiltering, _ as __nuxt_component_0 } from './server.mjs';
import { _ as _sfc_main$1 } from './StarRating-BlIPW-6i.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      if (unref(isOpen)) {
        _push(`<div class="mt-3 text-sm grid text-stone-500 gap-3"><div class="cursor-pointer flex gap-2 items-center"><input id="star-five"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(selectedTerms), "5")) ? " checked" : ""} type="radio" value="5" aria-label="5 stars"><label class="flex items-center" for="star-five">`);
...
//# sourceMappingURL=StarRatingFilter-Ksx3BQLn.mjs.map
