import { o as useI18n, p as useRoute, u as useCart, j as useAuth, q as useSeoMeta, i as useState, d as useHelpers, m as useRuntimeConfig, _ as __nuxt_component_0, e as __nuxt_component_10, b as _sfc_main$8$1, G as GqlUpdateCustomer, k as useRouter, l as GqlCheckout, c as _export_sfc, n as useAppConfig, f as _sfc_main$a$1 } from './server.mjs';
import { _ as _sfc_main$b } from './PasswordInput-B5YCbrv2.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$c } from './CountrySelect-BEXsV39Z.mjs';
import { useSSRContext, defineComponent, ref, computed, withAsyncContext, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, toRef, watch } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderList, ssrRenderSlot, ssrRenderStyle } from 'vue/server-renderer';
import { _ as __nuxt_component_0$1 } from './TrashIcon-DgRm1Dn1.mjs';
import { useSwipe } from '@vueuse/core';
import { _ as _sfc_main$d } from './ProductPrice-DLaqSb6r.mjs';
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_StateSelect = _sfc_main$1$1;
      const _component_CountrySelect = _sfc_main$c;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid w-full gap-4 lg:grid-cols-2" }, _attrs))}><div class="w-full"><label for="first-name">${ssrInterpolate(_ctx.$t("messages.billing.firstName"))}</label><input id="first-name"${ssrRenderAttr("value", unref(billing).firstName)} placeholder="John" autocomplete="given-name" type="text" required></div><div class="w-full"><label for="last-name">${ssrInterpolate(_ctx.$t("messages.billing.lastName"))}</label><input id="last-name"${ssrRenderAttr("value", unref(billing).lastName)} placeholder="Doe" autocomplete="family-name" type="text" required></div>`);
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full col-span-full"><label for="address1">${ssrInterpolate(_ctx.$t("messages.billing.address1"))}</label><input id="address1"${ssrRenderAttr("value", unref(billing).address1)} placeholder="O&#39;Connell Street 47" autocomplete="street-address" type="text" required></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full col-span-full"><label for="address2">${ssrInterpolate(_ctx.$t("messages.billing.address2"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</label><input id="address2"${ssrRenderAttr("value", unref(billing).address2)} placeholder="Apartment, studio, or floor" autocomplete="address-line2" type="text"></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full"><label for="city">${ssrInterpolate(_ctx.$t("messages.billing.city"))}</label><input id="city"${ssrRenderAttr("value", unref(billing).city)} placeholder="New York" autocomplete="locality" type="text" required></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full"><label for="state">${ssrInterpolate(_ctx.$t("messages.billing.state"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</label>`);
      ...
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full"><label for="country">${ssrInterpolate(_ctx.$t("messages.billing.country"))}</label>`);
      ...
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full"><label for="zip">${ssrInterpolate(_ctx.$t("messages.billing.zip"))}</label><input id="zip"${ssrRenderAttr("value", unref(billing).postcode)} placeholder="10001" autocomplete="postal-code" type="text" required></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(isBillingAddressEnabled)) {
        _push(`<div class="w-full col-span-full"><label for="phone">${ssrInterpolate(_ctx.$t("messages.billing.phone"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</label><input id="phone"${ssrRenderAttr("value", unref(billing).phone)} placeholder="+1 234 567 8901" autocomplete="tel" type="tel"></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_StateSelect = _sfc_main$1$1;
      const _component_CountrySelect = _sfc_main$c;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid w-full gap-4 lg:grid-cols-2" }, _attrs))}><div class="w-full"><label for="first-name">${ssrInterpolate(_ctx.$t("messages.billing.firstName"))}</label><input id="first-name"${ssrRenderAttr("value", unref(shipping).firstName)} placeholder="John" autocomplete="given-name" type="text" required></div><div class="w-full"><label for="last-name">${ssrInterpolate(_ctx.$t("messages.billing.lastName"))}</label><input id="last-name"${ssrRenderAttr("value", unref(shipping).lastName)} placeholder="Doe" autocomplete="family-name" type="text" required></div><div class="w-full col-span-full"><label for="address1">${ssrInterpolate(_ctx.$t("messages.billing.address1"))}</label><input id="address1"${ssrRenderAttr("value", unref(shipping).address1)} placeholder="O&#39;Connell Street 47" autocomplete="street-address" type="text" required></div><div class="w-full col-span-full"><label for="address2">${ssrInterpolate(_ctx.$t("messages.billing.address2"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</label><input id="address2"${ssrRenderAttr("value", unref(shipping).address2)} placeholder="Apartment, studio, or floor" autocomplete="address-line2" type="text"></div><div class="w-full"><label for="city">${ssrInterpolate(_ctx.$t("messages.billing.city"))}</label><input id="city"${ssrRenderAttr("value", unref(shipping).city)} placeholder="New York" autocomplete="locality" type="text" required></div><div class="w-full"><label for="state">${ssrInterpolate(_ctx.$t("messages.billing.state"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</label>`);
      _push(ssrRenderComponent(_component_StateSelect, {
        id: "state",
      ...
      _push(`</div><div class="w-full"><label for="zip">${ssrInterpolate(_ctx.$t("messages.billing.zip"))}</label><input id="zip"${ssrRenderAttr("value", unref(shipping).postcode)} placeholder="10001" autocomplete="postal-code" type="text" required></div><div class="w-full col-span-full"><label for="phone">${ssrInterpolate(_ctx.$t("messages.billing.phone"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</label><input id="phone"${ssrRenderAttr("value", unref(shipping).phone)} placeholder="+1 234 567 8901" autocomplete="tel" type="tel"></div></div>`);
    };
  }
});
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid gap-4 shipping-options" }, _attrs))} data-v-5e7c6934><!--[-->`);
      ssrRenderList(__props.options, (option) => {
        _push(`<div class="${ssrRenderClass([{ "active-option": option.id === __props.activeOption }, "flex items-center justify-between option"])}" data-v-5e7c6934><div data-v-5e7c6934><div class="text-sm leading-tight text-stone-500" data-v-5e7c6934>${option.label ?? ""}</div><div class="font-semibold text-stone-600" data-v-5e7c6934>${ssrInterpolate(unref(currencySymbol))}${ssrInterpolate(option.cost)}</div></div>`);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-5e7c6934"]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex gap-4 leading-tight flex-wrap" }, _attrs))} data-v-a601861d><!--[-->`);
      ssrRenderList((_a = _ctx.paymentGateways) == null ? void 0 : _a.nodes, (gateway) => {
        _push(`<div class="${ssrRenderClass([{ "active-option": gateway.id === unref(activePaymentMethod).id }, "option"])}"${ssrRenderAttr("title", (gateway == null ? void 0 : gateway.description) || (gateway == null ? void 0 : gateway.title) || "Payment Method")} data-v-a601861d>`);
        ...
        _push(`<span class="whitespace-nowrap" data-v-a601861d>${gateway.title ?? ""}</span>`);
        _push(ssrRenderComponent(_component_icon, {
          name: "ion:checkmark-circle",
          size: "20",
          class: "ml-auto text-primary checkmark opacity-0"
      ...
      if (unref(activePaymentMethod).description) {
        _push(`<div class="prose block w-full" data-v-a601861d><p class="text-sm text-stone-500" data-v-a601861d>${unref(activePaymentMethod).description ?? ""}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-a601861d"]]);
...
const _sfc_main$5 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isAlive)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-lg flex h-24 w-full overflow-hidden relative items-center" }, _attrs))}>`);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const productType = computed(() => {
      var _a, _b;
      return __props.item.variation ? (_a = __props.item.variation) == null ? void 0 : _a.node : (_b = __props.item.product) == null ? void 0 : _b.node;
    });
    ...
    watch(
      ...
      debounce(() => {
        if (quantity.value !== "") {
          updateItemQuantity(__props.item.key, quantity.value);
        }
      }, 250)
    );
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex rounded bg-white text-sm leading-none shadow-sm shadow-stone-200 isolate" }, _attrs))} data-v-feb5eec6><button title="Decrease Quantity" aria-label="Decrease Quantity" type="button" class="focus:outline-none border-r w-10 h-10 border rounded-l border-stone-300 hover:bg-stone-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(unref(isUpdatingCart) || unref(quantity) <= 0) ? " disabled" : ""} data-v-feb5eec6>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:remove",
        size: "14"
      }, null, _parent));
      _push(`</button><input${ssrRenderAttr("value", unref(quantity))} type="number" min="0"${ssrRenderAttr("max", unref(productType).stockQuantity)} aria-label="Quantity" class="flex items-center text-center justify-center w-10 px-2 text-xs focus:outline-none border-y border-stone-300" data-v-feb5eec6><button title="Increase Quantity" aria-label="Increase Quantity" type="button" class="focus:outline-none border-l w-10 h-10 border rounded-r hover:bg-stone-50 border-stone-300 disabled:cursor-not-allowed disabled:bg-stone-100"${ssrIncludeBooleanAttr(unref(isUpdatingCart) || unref(hasNoMoreStock)) ? " disabled" : ""} data-v-feb5eec6>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:add",
        size: "14"
      }, null, _parent));
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-feb5eec6"]]);
const _sfc_main$3 = {
  __name: "CartCard",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    const productSlug = computed(() => `/product/${decodeURIComponent(__props.item.product.node.slug)}`);
    ...
    const imgScr = computed(() => {
      var _a, _b, _c;
      return ((_a = productType.value.image) == null ? void 0 : _a.cartSourceUrl) || ((_b = productType.value.image) == null ? void 0 : _b.sourceUrl) || ((_c = __props.item.product.image) == null ? void 0 : _c.sourceUrl) || FALLBACK_IMG;
    });
    ...
    const removeItem = () => {
      updateItemQuantity(__props.item.key, 0);
    };
    const moveToWishList = () => {
      addToWishlist(__props.item.product.node);
      removeItem();
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProductPrice = _sfc_main$d;
          ...
          if (_push2) {
            if (unref(productType)) {
              ...
              if (unref(productType).salePrice) {
                _push2(`<span class="text-[10px] border-green-200 leading-none bg-green-100 inline-block p-0.5 rounded text-green-600 border"${_scopeId}> Megtakarítás ${ssrInterpolate(unref(salePercentage))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (unref(isLowStock)) {
              ...
              _push2(`<div class="text-xs text-stone-400 flex leading-none items-center"${_scopeId}>`);
              if (unref(storeSettings).showMoveToWishlist) {
                _push2(`<button class="mr-2 pr-2 border-r hover:text-dark" type="button"${_scopeId}>Kívánságlistára</button>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              unref(productType) ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "flex-1" }, [
                  createVNode("div", { class: "flex gap-x-2 gap-y-1 flex-wrap items-center" }, [
                    ...
                    }, " Megtakarítás " + toDisplayString(unref(salePercentage)), 1)) : createCommentVNode("", true),
                ...
                createVNode("div", { class: "inline-flex gap-2 flex-col items-end" }, [
                  ...
                  createVNode("div", { class: "text-xs text-stone-400 flex leading-none items-center" }, [
                    unref(storeSettings).showMoveToWishlist ? (openBlock(), createBlock("button", {
                      key: 0,
                      class: "mr-2 pr-2 border-r hover:text-dark",
                      type: "button",
                      onClick: moveToWishList
                    }, "Kívánságlistára")) : createCommentVNode("", true),
                    createVNode("button", {
                      title: "Remove Item",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cart)) {
        ...
        _push(`<div class="grid gap-1 text-sm font-semibold text-stone-500"><div class="flex justify-between"><span>${ssrInterpolate(_ctx.$t("messages.shop.subtotal"))}</span><span class="text-stone-700 tabular-nums">${unref(cart).subtotal ?? ""}</span></div><div class="flex justify-between"><span>${ssrInterpolate(_ctx.$t("messages.general.shipping"))}</span><span class="text-stone-700 tabular-nums">${ssrInterpolate(parseFloat(unref(cart).shippingTotal) > 0 ? "+" : "")} ${ssrInterpolate(unref(cart).shippingTotal)}</span></div>`);
        if (unref(cart) && unref(cart).appliedCoupons) {
        ...
        _push(`<div class="flex justify-between mt-4"><span>${ssrInterpolate(_ctx.$t("messages.shop.total"))}</span><span class="text-lg font-bold text-stone-700 tabular-nums">${unref(cart).total ?? ""}</span></div></div>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0;
      const _component_NuxtLink = __nuxt_component_10;
      const _component_PasswordInput = _sfc_main$b;
      const _component_BillingDetails = _sfc_main$a;
      const _component_ShippingDetails = _sfc_main$9;
      const _component_ShippingOptions = __nuxt_component_5;
      const _component_PaymentOptions = __nuxt_component_6;
      ...
      if (unref(cart) && unref(customer)) {
        ...
        if (unref(cart).isEmpty) {
          ...
          _push(`<h2 class="text-2xl font-bold mb-2">${ssrInterpolate(_ctx.$t("messages.shop.cartEmpty"))}</h2><span class="text-stone-400 mb-4">${ssrInterpolate(_ctx.$t("messages.shop.addProductsInYourCart"))}</span>`);
          ...
          if (!unref(viewer) && unref(customer).billing) {
            _push(`<div><h2 class="w-full mb-2 text-2xl leading-none">Elérhetőség</h2><p class="mt-1 text-sm text-stone-500">Már van felhasználó fiókja? <a href="/my-account" class="text-primary text-semibold">Bejelentkezés</a>.</p><div class="w-full mt-4"><label for="email">${ssrInterpolate(_ctx.$t("messages.billing.email"))}</label><input${ssrRenderAttr("value", unref(customer).billing.email)} placeholder="johndoe@email.com" autocomplete="email" type="email" name="email" class="${ssrRenderClass({ "has-error": unref(isInvalidEmail) })}" required>`);
            if (unref(isInvalidEmail)) {
              _push(`<div class="mt-1 text-sm text-red-500">Hibás email cím</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
            if (unref(orderInput).createAccount) {
              _push(`<!--[--><div class="w-full mt-4"><label for="username">${ssrInterpolate(_ctx.$t("messages.account.username"))}</label><input${ssrRenderAttr("value", unref(orderInput).username)} placeholder="johndoe" autocomplete="username" type="text" name="username" required></div>`);
              if (unref(orderInput).createAccount) {
          ...
          _push(`<div><h2 class="w-full mb-3 text-2xl">${ssrInterpolate(_ctx.$t("messages.billing.billingDetails"))}</h2>`);
          ...
          _push(`</div>`);
          if (unref(cart).availableShippingMethods.length > 0) {
            _push(`<label for="shipToDifferentAddress" class="flex items-center gap-2"><span>${ssrInterpolate(_ctx.$t("messages.billing.differentAddress"))}</span><input id="shipToDifferentAddress"${ssrIncludeBooleanAttr(Array.isArray(unref(orderInput).shipToDifferentAddress) ? ssrLooseContain(unref(orderInput).shipToDifferentAddress, null) : unref(orderInput).shipToDifferentAddress) ? " checked" : ""} type="checkbox" name="shipToDifferentAddress"></label>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(orderInput).shipToDifferentAddress) {
            _push(`<div><h2 class="mb-4 text-xl">${ssrInterpolate(_ctx.$t("messages.general.shippingDetails"))}</h2>`);
          ...
          if (unref(cart).availableShippingMethods.length) {
            _push(`<div><h3 class="mb-4">${ssrInterpolate(_ctx.$t("messages.general.shippingSelect"))}</h3>`);
          ...
          if ((_a2 = unref(paymentGateways)) == null ? void 0 : _a2.nodes.length) {
            _push(`<div class="mt-2 col-span-full"><h2 class="mb-4 text-xl">${ssrInterpolate(_ctx.$t("messages.billing.paymentOptions"))}</h2>`);
            _push(ssrRenderComponent(_component_PaymentOptions, {
              ...
              class: "mb-4",
              "payment-gateways": unref(paymentGateways)
            }, null, _parent));
            if (unref(stripe)) {
          ...
          _push(`<div><h2 class="mb-4 text-xl">${ssrInterpolate(_ctx.$t("messages.shop.orderNote"))} (${ssrInterpolate(_ctx.$t("messages.general.optional"))})</h2><textarea id="order-note" name="order-note" class="w-full min-h-[100px]" rows="4"${ssrRenderAttr("placeholder", _ctx.$t("messages.shop.orderNotePlaceholder"))}>${ssrInterpolate(unref(orderInput).customerNote)}</textarea></div></div>`);
          _push(ssrRenderComponent(_component_OrderSummary, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button class="flex items-center justify-center w-full gap-3 p-3 mt-4 text-center text-white rounded-lg shadow-md bg-primary hover:bg-primary-dark disabled:cursor-not-allowed disabled:bg-stone-400"${ssrIncludeBooleanAttr(unref(isCheckoutDisabled)) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(unref(buttonText))}`);
...
//# sourceMappingURL=checkout-B_IEamxG.mjs.map
