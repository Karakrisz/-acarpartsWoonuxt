...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative flex items-center w-full" }, _attrs))}><input${ssrRenderAttr("type", unref(showPassword) ? "text" : "password")}${ssrRenderAttr("value", __props.modelValue)} class="${ssrRenderClass([__props.className, "flex items-center flex-1"])}"${ssrRenderAttr("placeholder", __props.placeholder)}${ssrRenderAttr("autocomplete", __props.autocomplete)}${ssrIncludeBooleanAttr(__props.required) ? " required" : ""}>`);
...
//# sourceMappingURL=PasswordInput-B5YCbrv2.mjs.map
