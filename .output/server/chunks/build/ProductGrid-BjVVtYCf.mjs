import { x as useSorting, n as useAppConfig, y as useFiltering, d as useHelpers, p as useRoute, w as useProducts, z as useSearching, c as _export_sfc, _ as __nuxt_component_0, m as useRuntimeConfig, e as __nuxt_component_10 } from './server.mjs';
import { toRefs, ref, computed, onMounted, onUnmounted, watch, openBlock, createElementBlock, mergeProps, useSSRContext, defineAsyncComponent, withAsyncContext, unref, defineComponent, withCtx, createVNode, createTextVNode, toDisplayString, isRef } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrRenderSlot } from 'vue/server-renderer';
import { a as _sfc_main$c } from './ProductCard-ocl8XymJ.mjs';
...
const _sfc_main$b = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "inline-flex ml-auto -space-x-px shadow-sm rounded-m isolate" }, _attrs))}><button class="relative inline-flex items-center p-2 text-sm font-medium text-stone-500 bg-white border border-stone-300 rounded-l-md hover:bg-stone-50 focus:z-20" aria-label="Sort">`);
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div style="${ssrRenderStyle(unref(isOpen) ? null : { display: "none" })}" class="mt-3 grid gap-4 grid-cols-2"><div class="flex relative items-center"><input id="price-from"${ssrRenderAttr("value", unref(price)[0])} class="bg-white border rounded-lg max-w-full border-stone-200 leading-none w-auto p-2 pl-6 md:text-sm" type="number" placeholder="From" min="0"><label for="price-from" class="leading-none px-2 text-stone-400 absolute">${unref(currencySymbol) ?? ""}</label></div><div class="flex relative items-center"><input id="price-to"${ssrRenderAttr("value", unref(price)[1])} class="bg-white border rounded-lg max-w-full border-stone-200 leading-none w-auto p-2 pl-6 md:text-sm" type="number" placeholder="Up to" min="1"><label for="price-to" class="leading-none px-2 text-stone-400 absolute">${unref(currencySymbol) ?? ""}</label></div><div class="mx-1 mt-1 col-span-full">`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.terms.length) {
        ...
        ssrRenderList(__props.terms, (term) => {
          _push(`<div class="flex gap-2 items-start"><input${ssrRenderAttr("id", term.slug)}${ssrIncludeBooleanAttr(Array.isArray(unref(selectedTerms)) ? ssrLooseContain(unref(selectedTerms), term.slug) : unref(selectedTerms)) ? " checked" : ""} type="checkbox"${ssrRenderAttr("value", term.slug)}><label${ssrRenderAttr("for", term.slug)} class="cursor-pointer m-0 text-sm flex-1 leading-tight"><span>${term.name ?? ""}</span>`);
          if (__props.showCount) {
            _push(`<small class="ml-1 text-stone-400 tabular-nums" aria-hidden="true">(${ssrInterpolate(term.count || 0)})</small>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</label></div>`);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { getFilter, setFilter, isFiltersActive } = useFiltering();
    const selectedTerms = ref(getFilter(__props.attribute.slug) || []);
    const filterTitle = ref(__props.attribute.label || __props.attribute.slug);
    const isOpen = ref(__props.attribute.openByDefault);
    watch(isFiltersActive, () => {
      if (!isFiltersActive.value) selectedTerms.value = [];
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<!--[--><div class="cursor-pointer flex font-semibold mt-8 leading-none justify-between items-center" data-v-bf932b61><span data-v-bf932b61>${ssrInterpolate(unref(filterTitle))}</span>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:chevron-down-outline",
        class: ["transform", unref(isOpen) ? "rotate-180" : ""]
      }, null, _parent));
      _push(`</div><div style="${ssrRenderStyle(unref(isOpen) ? null : { display: "none" })}" class="mt-3 mr-6 max-h-[240px] grid gap-1.5 swatches overflow-auto custom-scrollbar" data-v-bf932b61><!--[-->`);
      ssrRenderList(__props.attribute.terms, (color) => {
        _push(`<div style="${ssrRenderStyle({ "--color": color.slug })}"${ssrRenderAttr("title", color.name)} data-v-bf932b61><input${ssrRenderAttr("id", color.slug)}${ssrIncludeBooleanAttr(Array.isArray(unref(selectedTerms)) ? ssrLooseContain(unref(selectedTerms), color.slug) : unref(selectedTerms)) ? " checked" : ""} class="hidden" type="checkbox"${ssrRenderAttr("value", color.slug)} data-v-bf932b61><label${ssrRenderAttr("for", color.slug)} class="cursor-pointer m-0" data-v-bf932b61></label></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-bf932b61"]]);
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.attribute.terms, (term) => {
        _push(`<div class="flex gap-2 items-center"><input${ssrRenderAttr("id", term.slug)}${ssrIncludeBooleanAttr(Array.isArray(unref(selectedTerms)) ? ssrLooseContain(unref(selectedTerms), term.slug) : unref(selectedTerms)) ? " checked" : ""} type="checkbox"${ssrRenderAttr("value", term.slug)}><label${ssrRenderAttr("for", term.slug)} class="cursor-pointer m-0 text-sm flex items-center flex-wrap"><span>${term.name ?? ""}</span>`);
        if (__props.attribute.showCount) {
          _push(`<small class="ml-1 text-stone-400 tabular-nums" aria-hidden="true">(${ssrInterpolate(term.count || 0)})</small>`);
        } else {
          _push(`<!---->`);
        }
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="cursor-pointer flex font-semibold mt-8 leading-none justify-between items-center"><span>Csak leárazott termékek</span>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ion:chevron-down-outline",
        class: ["transform", unref(isOpen) ? "rotate-180" : ""]
      }, null, _parent));
...
const __nuxt_component_6_lazy = defineAsyncComponent(() => import('./StarRatingFilter-Ksx3BQLn.mjs').then((c) => c.default || c));
const __nuxt_component_7_lazy = defineAsyncComponent(() => import('./ResetFiltersButton-hjHlwLQo.mjs').then((c) => c.default || c));
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    globalProductAttributes.map((attr) => {
      var _a2;
      return (_a2 = attr == null ? void 0 : attr.slug) == null ? void 0 : _a2.toUpperCase().replace("_", "");
    });
    ref([]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isLoading.value) {
        _push(`<!--[-->`);
        ssrRenderList(unref(placeholderItems), (_, index) => {
          _push(`<div class="py-6 animate-pulse"><div class="flex items-center mb-4"><div class="w-24 h-5 bg-gray-200 rounded"></div></div><div class="space-y-3"><!--[-->`);
          ssrRenderList(3, (i) => {
            _push(`<div class="flex items-center gap-2"><div class="w-4 h-4 bg-gray-200 rounded"></div><div class="w-20 h-4 bg-gray-200 rounded"></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        });
        _push(`<!--]-->`);
        ...
        if (!__props.hideCategories) {
          _push(ssrRenderComponent(_component_CategoryFilter, { terms: productCategoryTerms.value }, null, _parent));
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(attributesWithTerms.value, (attribute) => {
          _push(`<div>`);
          if (attribute.slug == "pa_color" || attribute.slug == "pa_colour") {
            _push(ssrRenderComponent(_component_ColorFilter, { attribute }, null, _parent));
          } else {
            _push(ssrRenderComponent(_component_GlobalFilter, { attribute }, null, _parent));
          }
          _push(`</div>`);
        });
        _push(`<!--]-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_a = unref(products)) == null ? void 0 : _a.length) !== 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "text-sm font-light" }, _attrs))}><span>${ssrInterpolate(_ctx.$t("messages.shop.productResultCount.showing") + " ")}</span><span class="font-normal">${ssrInterpolate((unref(page) - 1) * unref(productsPerPage) + 1 + " ")}</span><span>${ssrInterpolate(_ctx.$t("messages.shop.productResultCount.to") + " ")}</span><span class="font-normal">${ssrInterpolate(Math.min(unref(page) * unref(productsPerPage), (_b = unref(products)) == null ? void 0 : _b.length) + " ")}</span> (<span>${ssrInterpolate(_ctx.$t("messages.shop.productResultCount.of"))}</span> <span class="font-normal">${ssrInterpolate((_c = unref(products)) == null ? void 0 : _c.length)}</span>) </div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative inline-flex -space-x-px shadow-sm rounded-m isolate" }, _attrs))}><button class="relative inline-flex items-center p-2 text-sm text-stone-500 bg-white border border-stone-300 rounded-md hover:bg-stone-50 focus:z-20" aria-label="Show filters" title="Show filters">`);
      _push(ssrRenderComponent(_component_Icon, {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex justify-center mt-8 mb-16 col-span-full tabular-nums" }, _attrs))} data-v-d94c3980>`);
      if (unref(numberOfPages) && unref(numberOfPages) > 1) {
        _push(`<nav class="inline-flex self-end -space-x-px rounded-md shadow-sm isolate" aria-label="Pagination" data-v-d94c3980>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d94c3980"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h2 class="text-2xl font-bold">${ssrInterpolate(_ctx.$t("messages.shop.noProductsFound.title"))}</h2><p class="mt-4 max-w-md">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, () => {
        _push(`${ssrInterpolate(_ctx.$t("messages.shop.noProductsFound.subText"))}`);
      }, _push, _parent);
      _push(`</p><div>`);
      if (unref(allProducts).length) {
        _push(`<button class="button button-primary mt-8"${ssrRenderAttr("title", _ctx.$t("messages.shop.noProductsFound.clearFiltersAndSearch"))} aria-label="Clear all filters and search">${ssrInterpolate(_ctx.$t("messages.shop.noProductsFound.clearFiltersAndSearch"))}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!!unref(products).length) {
        _push(`<section class="relative w-full" data-v-d61ee510><div${ssrRenderAttrs({
          name: "shrink",
          mode: "in-out",
          class: "product-grid"
        })} data-v-d61ee510>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d61ee510"]]);

export { _sfc_main$5 as _, _sfc_main$4 as a, _sfc_main$b as b, _sfc_main$3 as c, __nuxt_component_4 as d, _sfc_main$1 as e };
//# sourceMappingURL=ProductGrid-BjVVtYCf.mjs.map
